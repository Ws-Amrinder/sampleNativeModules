...
struct AffirmationOverlay: View {
  var body: some View {
    VStack(spacing: 14){
      Image(systemName: "leaf")
        .foregroundColor(.white)
      Rectangle().frame(height:2).padding(.horizontal, 100)
      Text("You're doing Great").font(.system(size: 20))
    ...
    var body: some View {
        ZStack {
          Image(.widgetBackground)
            ...
            .overlay(AffirmationOverlay(), alignment: .center)
      }
    }
}
